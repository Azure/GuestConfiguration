...
function Test-GuestConfigurationPackage {
    ...
    Try {
        ...
        # For Set scenario, run Start-Dsc command
        if ($Type -eq "Set") {
...
Export-ModuleMember -Function @('New-GuestConfigurationPackage', 'Test-GuestConfigurationPackage', 'Install-GuestConfigurationPackage', 'Protect-GuestConfigurationPackage', 'Publish-GuestConfigurationPackage', 'New-GuestConfigurationPolicy', 'Publish-GuestConfigurationPolicy')
