...
'@                
    ...
    InModuleScope -ModuleName 'GuestConfiguration' {
        ...
        It 'Verify New-GuestConfigurationPolicy cmdlet can create custom policy definitions' {
            ...
            write-warning $($jsonDefinition.properties.policyRule.if.anyOf.allOf | ConvertTo-Json)
            $resourceTypes = $jsonDefinition.properties.policyRule.if.anyOf.allOf | Where-Object {$_.field -eq 'type'} | ForEach-Object {$_.equals}
