...
"@
    ...
    It 'Create Custom policy package and test its contents' -Skip:(-not(Run-Test)){
    ...
    It 'Verify Test-GuestConfigurationPackage can validate the package generated by New-GuestConfigurationPackage' -Skip:(-not(Run-Test)){
    ...
    It 'Verify Protect-GuestConfigurationPackage cmdlet can sign policy package' -Skip:(-not(Run-Test)){
    ...
    It 'Verify New-GuestConfigurationPolicy cmdlet can create custom policy definitions' -Skip:(-not(Run-Test)){
...
<#
    It 'Verify Publish-GuestConfigurationPolicy cmdlet can publish the custom policy generated by New-GuestConfigurationPolicy cmdlets' -Skip:(-not(Run-Test)){
        $testpolicyName = 'AuditWindowsService'
        $contentURI = 'https://github.com/microsoft/PowerShell-DSC-for-Linux/raw/amits/custompolicy/new_gc_policy/AuditWindowsService.zip'
        $policyPath = "$testOutputPath\policyDefinitions"
        $displayName = '[unittest] Audit Windows Service.'
