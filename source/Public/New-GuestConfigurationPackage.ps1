...
function New-GuestConfigurationPackage
{
    ...
    if ($usingInSpecResource)
    {
        ...
        Write-Verbose -Message "Copying the native Chef Inspec resource schema from the path '$inSpecResourceSchemaMofSourcePath' to '$inSpecResourceSchemaMofDestinationPath'..."
